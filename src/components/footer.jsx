            ...
            <div className="px-4 mx-auto sm:px-6 lg:px-8 w-75">
                <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-12 gap-y-12 gap-x-8 xl:gap-x-12">
                    <div className="col-span-2 md:col-span-4 ">
                        ...
                        The optimal approach to safeguarding your money <br /> is by creating a well-structured savings plan.
                        </p>
                        {/* <a
                            href="#"
                            title=""
                            className="inline-flex items-center justify-center px-6 py-4 font-semibold text-white transition-all duration-200 bg-[#338c8e] rounded-md hover:bg-[#2C7A7B] focus:bg-blue-700 mt-7"
                        >
                            <svg
                                className="w-6 h-6"
                ...
                <div className="sm:flex sm:items-center sm:justify-between">
                    <p className="text-sm text-gray-600">
                        © Copyright {new Date().getFullYear()}, All Rights Reserved by Turned
                    </p>
